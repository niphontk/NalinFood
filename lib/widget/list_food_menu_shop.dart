...
import 'package:food/screens/add_food_menu.dart';
import 'package:food/screens/edit_food_menu.dart';
            ...
            children: <Widget>[
              FlatButton(
                onPressed: () async {
                  ...
                  String url =
                      '${MyConstant().domain}/nalinfood/deleteFoodWhereId.php?isAdd=true&id=${foodModel.id}';
